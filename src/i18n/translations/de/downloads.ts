...
export const downloads: DownloadsTranslations = {
  ...
  desktop: {
    title: 'Für Desktop herunterladen',
    choosePlatform: 'Wählen Sie Ihre Plattform:',
    macos: 'macOS',
    windows: 'Windows',
    linux: 'Linux'
  },
  mobile: {
    appStore: 'App Store',
    appStoreSubtitle: 'Herunterladen im',
    googlePlay: 'Google Play',
    googlePlaySubtitle: 'JETZT BEI'
  },
  downloadFree: 'KOSTENLOS ERHALTEN',
