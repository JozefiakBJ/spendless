        ...
        <div className="max-w-md w-full">
          <Card className="border-sand-200 shadow-lg">
            <CardHeader className="space-y-1 bg-sand-50 rounded-t-lg">
              <CardTitle className="text-2xl font-bold text-center text-sand-900">Sign in to SPENDLESS</CardTitle>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex items-center space-x-2 space-y-0">
                          ...
                          <FormLabel className="text-sm font-medium text-sand-700 cursor-pointer">
                            Remember me
                          </FormLabel>
                        </FormItem>
                      )}
              ...
              <div className="mt-6 text-center">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-sand-600">Or continue with</span>
                  </div>
                </div>
